...
namespace Exthand.GatewayClient
{
    public class GatewayService : IGatewayService
    {
        ...
        public async Task<IEnumerable<Bank>> GetBanksAsync(string countryCode)
        {
            ...
            {
                return JsonConvert.DeserializeObject<IEnumerable<Bank>>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<BankPaymentAccessOption> GetBankPaymentAccessOptionsAsync(int connectorId)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<BankPaymentAccessOption>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<PaymentInitResponse> PaymentInitiateAsync(PaymentInitRequest paymentInitRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<PaymentInitResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<PaymentFinalizeResponse> PaymentFinalizeAsync(PaymentFinalizeRequest paymentFinalizeRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<PaymentFinalizeResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<PaymentStatusResponse> PaymentStatusAsync(PaymentStatusRequest paymentStatusRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<PaymentStatusResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<BankAccessOption> GetBankAccessOptionsAsync(int connectorId)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<BankAccessOption>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<BankAccessResponse> RequestBankAccessAsync(BankAccessRequest bankAccessRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<BankAccessResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<BankAccessResponseFinalize> FinalizeRequestBankAccessAsync(BankAccessRequestFinalize bankAccessRequestFinalize)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<BankAccessResponseFinalize>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<BankAccountsResponse> GetBankAccountsAsync(BankAccountsRequest bankAccountsRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<BankAccountsResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<BalanceResponse> GetBalancesAsync(string accountId, BalanceRequest balanceRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<BalanceResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<TransactionResponse> GetTransactionsAsync(string accountId, TransactionRequest transactionRequest)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<TransactionResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<TermsDTO> GetTCAsync()
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<TermsDTO>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<TermsValidated> GetTCLatestAsync(string psuId)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<TermsValidated>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
        ...
        public async Task<UserRegisterResponse> CreateUserAsync(UserDTO userDTO)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<UserRegisterResponse>(await result.Content.ReadAsStringAsync());
            }
            else if (result.StatusCode == HttpStatusCode.BadRequest)
            {
                var error = JsonConvert.DeserializeObject<Error>(await result.Content.ReadAsStringAsync());
